...
import { roleDisplayNames, roleDescriptions, roleRoutes } from "@/lib/types";
...
const roleCards = [
  ...
  {
    role: "asha" as Role,
    description: roleDescriptions["asha"],
          ...
          {roleCards.map((card) => (
            ...
            >
              ...
              <Button
                ...
                aria-label={`Access Dashboard for ${roleDisplayNames[card.role]}`}
              >
                Access Dashboard
              </Button>
            </div>
